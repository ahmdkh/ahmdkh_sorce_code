<?
	 ...
	 if ($_POST['submitForm'])
	{
		...
		//echo '$Type-Disability[]';
		
	{
	                $koko='ahmadk'.implode(',', $_POST['Type_Disability']); 
        dbInsert('work_chance', array('work_name','Work_chance_count','Work_hours','Name_qualified','Type_Disability','address', 'Salary','Age','Company-type'), 
		array(mysql_real_escape_string($_POST['name_work']), 
	...
	successMessage('تم تسجيل فرصه عمل لشركتك الخاصه ضمن موقعنا بنجاح');
		//redirect('signIn.php');
	}
